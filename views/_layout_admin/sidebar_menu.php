    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Tags<i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o"></i>Tags Posts</a></li>
                </ul>
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o"></i>Tags Products</a></li>
                </ul>
            </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i> Receipts<i class="fa fa-angle-left pull-right"></i></a>
                ...
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o"></i>Receipts Detail</a></li>
                </ul>
            </li>
        </ul>
        <ul class="treeview-menu">
