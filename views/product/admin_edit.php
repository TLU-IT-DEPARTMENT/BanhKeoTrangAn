...
<form role="form" method="post" enctype="multipart/form-data">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="Model" value="<?= $this->data['item']['Model']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Model" required>
        </div>
        <div class="form-group">
            <label for="">UnitPrice</label><span class="red-require"><strong>*</strong></span>
            <input type="text" name="UnitPrice"  value="<?= $this->data['item']['UnitPrice']; ?>"class="form-control" id="exampleInputPassword1" placeholder="UnitPrice" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="Rate" value="<?= $this->data['item']['Rate']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Rate">
        </div>
        <div class="form-group">
            <label for="">RatePeople</label>
            <input type="text" name="RatePeople" value="<?= $this->data['item']['RatePeople']; ?>" class="form-control" id="exampleInputPassword1" placeholder="RatePeople">
        </div>
        <div class="form-group">
            <label for="">Status</label><span class="red-require"><strong>*</strong></span>
            <select class="form-control" id="postStatus" name="Status">
                <option value="<?php if ($this->data['item']['Status'] == 1) echo 'selected' ?>">Enable</option>
                <option value="<?php if ($this->data['item']['Status'] == 0) echo 'selected' ?>">Disable</option>
            </select>
        </div>
    </div><!-- /.box-body -->
